...
* Mean total number of steps taken per day= `r meanDay`
* Median total number of steps taken per day= `r medianDay`
...
* `r maxInterval` (5-minute interval), on average across all the days in the dataset, contains the maximum number of steps `r maxSteps`.
...
* Total number of missing values (coded as NA) is `r noNa`.

Missing values in the datasets activity filled in

* Mean total number of steps taken per day= `r meanDay1`
* Median total number of steps taken per day= `r medianDay1`
